...
import AirtimeContent from './content/AirtimeContent';
import AirtimeSwap from './content/AirtimeSwap';
import CableTv from './content/CableTv';
import DataPin from './content/DataPin';
import Data from './content/Data';
import Electricity from './content/Electricity';
import ExamPin from './content/ExamPin';
import Referrals from './content/Referrals';
import { airtel, etisalat, glo, mtn } from '../../assets';

const ServiceModal = ({ modalIsOpen, closeModal, serviceType }) => {
  ...
  switch (serviceType) {
    case 'airtime':
      ModalContent = AirtimeContent;
      break;
    case 'data':
      ModalContent = Data;
      break;
    case 'airtimeswap':
        ModalContent = AirtimeSwap;
        break;
    case 'cabletv':
        ModalContent = CableTv;
        break;
    case 'datapin':
        ModalContent = DataPin;
        break;
    case 'electricity':
        ModalContent = Electricity;
        break;
    case 'exampin':
        ModalContent = ExamPin;
        break;
    case 'referrals':
        ModalContent = Referrals;
        break;
        ...
        <div className="bg-white rounded-3xl shadow-lg w-full max-w-md p-7">
          ...
          <div className="grid grid-cols-2 gap-[46px] p-3 mt-9">
            {networks.map((network) => (
              ...
              >
                <img src={network.img} alt={network.name} className="w-full h-auto" />
